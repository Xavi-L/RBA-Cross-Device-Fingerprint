...
本目录用于保存毕业论文写作过程中的材料，包括候选参考文献、文献综述笔记、章节草稿、图表说明和引用格式整理。
...
- `chapter4_experiment_analysis.md`：第 4 章“实验设计与结果分析”正文草稿，依据根目录第四章大纲和 `ablation/` 实验结果撰写。
- `chapter5_conclusion.md`：第 5 章“结论与展望”正文草稿，对全文工作、实验结论和后续方向进行简要总结。
