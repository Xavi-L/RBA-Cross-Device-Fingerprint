...
- 本文件是候选库，不是最终参考文献列表。
- 优先选择2023年及以后的正式会议、期刊、出版社页面或官方技术文档，尽量避免 arXiv。
- 少量2022年及以前文献保留为“经典基础文献”，用于支撑设备指纹、WebView 安全和跨浏览器指纹等基础概念。
- 后续写论文时建议保留约30-36篇正式引用，正文引用和文末参考文献一一对应。
...
- 设备指纹 / 浏览器指纹：8-10篇
- Android / WebView / Hybrid App：5-7篇
- 风险自适应认证与移动端无感认证：5-6篇
- 端侧推理与轻量模型：3-4篇
- LLM 安全分析与规则辅助：2-3篇
- 官方标准/技术资料：2-4篇
...
- 对 A 类文献逐篇精读摘要、方法、结论，提炼可直接写入论文的1-2句话。
- 查每篇正式 BibTeX 或 DOI，转为 GB/T 7714格式。
