...
build_time_vars = {
    ...
    "ALT_SOABI": 0,
    "ANDROID_API_LEVEL": 0,
    "AR": "/tmp/tmphvbjdv63/tools/llvm/bin/llvm-ar",
    "ARFLAGS": "rcs",
    ...
    "FILEMODE": 644,
    "FREEZE_MODULE": "/tmp/tmphvbjdv63/tools/host/bin/python3.12 ./Programs/_freeze_module.py",
    "FREEZE_MODULE_BOOTSTRAP": "/tmp/tmphvbjdv63/tools/host/bin/python3.12 ./Programs/_freeze_module.py",
    ...
    "LIBMPDEC_CFLAGS": "-DCONFIG_64=1 -DUNIVERSAL=1 -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -O3 -arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new -flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=/private/tmp/tmphvbjdv63/Python-3.12.14/code.profclangd -I./Include/internal -I. -I./Include -O3 -arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new",
    "LIBMPDEC_HEADERS": "\\",
    "LIBMPDEC_OBJS": "\\",
    "LIBOBJDIR": "Python/",
    "LIBOBJS": "",
    ...
    "LLVM_PROFDATA": "/tmp/tmphvbjdv63/tools/llvm/bin/llvm-profdata",
    "LLVM_PROF_ERR": "no",
    "LLVM_PROF_FILE": "LLVM_PROFILE_FILE=\"$(shell pwd)/code-%128m.profclangr\"",
    "LLVM_PROF_MERGER": "/tmp/tmphvbjdv63/tools/llvm/bin/llvm-profdata merge -output=\"$(shell pwd)/code.profclangd\" \"$(shell pwd)\"/*.profclangr",
    "LN": "ln",
    "LOCALMODLIBS": "-lmpdec -lz -lbz2  -llzma -pthread -lpthread -lz -lreadline    Modules/_hacl/libHacl_Hash_SHA2.a   -lexpat                      -lffi -ldl -lncurses -lpanel -lncurses  -lsqlite3 -lz   -lssl -lcrypto    -lcrypto -luuid -framework SystemConfiguration -framework CoreFoundation",
    "MACHDEP": "darwin",
    "MACHDEP_OBJS": "",
    ...
    "MODULE__DECIMAL_CFLAGS": "-DCONFIG_64=1 -DUNIVERSAL=1",
    ...
    "PYTHONPATH": "",
    "PYTHON_FOR_BUILD": "_PYTHON_PROJECT_BASE=/private/tmp/tmphvbjdv63/Python-3.12.14 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /private/tmp/tmphvbjdv63/Python-3.12.14/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin /tmp/tmphvbjdv63/tools/host/bin/python3.12",
    "PYTHON_FOR_BUILD_DEPS": "",
    "PYTHON_FOR_FREEZE": "/tmp/tmphvbjdv63/tools/host/bin/python3.12",
    "PYTHON_FOR_REGEN": "",
    "PYTHON_HEADERS": "\\",
    "PYTHON_OBJS": "\\",
    ...
    "PY_CFLAGS_NODIST": "-flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=/private/tmp/tmphvbjdv63/Python-3.12.14/code.profclangd -I./Include/internal",
    ...
    "RETSIGTYPE": "void",
    "RUNSHARED": "DYLD_LIBRARY_PATH=/private/tmp/tmphvbjdv63/Python-3.12.14",
    ...
    "TESTOPTS": "",
    "TESTPATH": "",
    "TESTPYTHON": "DYLD_LIBRARY_PATH=/private/tmp/tmphvbjdv63/Python-3.12.14 _PYTHON_PROJECT_BASE=/private/tmp/tmphvbjdv63/Python-3.12.14 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /private/tmp/tmphvbjdv63/Python-3.12.14/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin /tmp/tmphvbjdv63/tools/host/bin/python3.12",
    "TESTPYTHONOPTS": "",
    "TESTRUNNER": "DYLD_LIBRARY_PATH=/private/tmp/tmphvbjdv63/Python-3.12.14 _PYTHON_PROJECT_BASE=/private/tmp/tmphvbjdv63/Python-3.12.14 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /private/tmp/tmphvbjdv63/Python-3.12.14/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin /tmp/tmphvbjdv63/tools/host/bin/python3.12 ./Tools/scripts/run_tests.py",
    ...
    "abs_builddir": "/private/tmp/tmphvbjdv63/Python-3.12.14",
    "abs_srcdir": "/private/tmp/tmphvbjdv63/Python-3.12.14",
