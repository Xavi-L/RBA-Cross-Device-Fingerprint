...
from .access import _derived, authorize
...
def fixed_model(access, method):
    ...
    return RuleModel(method, status, clauses, atoms,
        {k: b[k] for k in ("study_version", "protocol_digest", "candidate_version", "input_manifest_ref")} |
        {"fold_id": access.fold_id, "split_id": "SYNTHETIC", "operating_point": "NOT_APPLICABLE",
         ...
         "data_origin": "BUILTIN_SYNTHETIC"}, access.view,
